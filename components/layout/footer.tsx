        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-6">
              <div className="bg-white text-primary-900 p-2 rounded-lg mr-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                </svg>
              </div>
              <div>
                <h2 className="text-2xl font-bold">Quran Institute</h2>
                <p className="text-primary-200">Learn Quran Online</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-primary-800 p-3 rounded-lg hover:bg-primary-700 transition-colors">
